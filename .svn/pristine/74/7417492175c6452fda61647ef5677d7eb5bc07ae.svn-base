...
function updateAreaData(that, status, e) {
  ...
  var getProvinceData = function() {
    var s;
    provinces = [];
    var provs = app.changeAreaToObj("86");
    var num = 0;
    for (var i = 0; i < provs.length; i++) {
      var obj = {};
      obj.code = provs[i].code;
      obj.name = provs[i].name;
      provinces[num] = obj;
      num++;
    }
  ...
  var getCityArr = function(count = 0) {
    var provs = app.changeAreaToObj(provinces[count].code);
    var c;
    citys = [];
    var num = 0;
  ...
  var getCountyInfo = function(column0 = 0, column1 = 0) {
    var provs = app.changeAreaToObj(citys[column1].code);
    var c;
    countys = [];
    var num = 0;
    for (var i = 0; i < provs.length; i++) {
